...
const errorCodeMap = {
  ...
  [ErrorType.invalidMFATrustToken]: HttpStatusCode.FORBIDDEN,
  [ErrorType.mfaRequired]: HttpStatusCode.FORBIDDEN,
  [ErrorType.invalidWebhook]: HttpStatusCode.INTERNAL_SERVER_ERROR,
  [ErrorType.unavailableService]: HttpStatusCode.SERVICE_UNAVAILABLE,
  [ErrorType.notValidUser]: HttpStatusCode.FORBIDDEN,
  [ErrorType.notVerified]: HttpStatusCode.UNAUTHORIZED,
  [ErrorType.pepOrPaused]: HttpStatusCode.FORBIDDEN,
  [ErrorType.commitExpired]: HttpStatusCode.BAD_REQUEST,
  [ErrorType.maxWithdrawalLimitOrAmountReached]: HttpStatusCode.BAD_REQUEST,
  [ErrorType.minWithdrawalLimitNotMet]: HttpStatusCode.BAD_REQUEST,
  [ErrorType.addressSanctioned]: HttpStatusCode.FORBIDDEN,
};
