...
function getEnvironment(key, defaultValue) {
  return _nullishCoalesce(_nullishCoalesce(process.env[key], () => ( defaultValue)), () => ( ""));
}
_chunkTUYBEZEZjs.__name.call(void 0, getEnvironment, "getEnvironment");
var environment = {
...
_chunkTUYBEZEZjs.__name.call(void 0, extendSharedEnvironment, "extendSharedEnvironment");





exports.getEnvironment = getEnvironment; exports.environment = environment; exports.extendSharedEnvironment = extendSharedEnvironment;
//# sourceMappingURL=chunk-2RIL52B7.js.map